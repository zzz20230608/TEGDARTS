...
class Architect(object):
    ...
    def __init__(self, model, args):
        ...
        self.optimizer_wot = torch.optim.Adam(self.model.arch_parameters(),
                                          lr=0.02)
    ...
    def _backward_step(self, input_valid, target_valid):
        ...
        # print('loss',loss,'loss_wot',loss_wot) # zzz for test
        # loss=loss+loss_wot
        loss.backward()
    ...
    def generate_arch(self, actions):
        arch_parameters = [-INF * torch.ones_like(alpha) for alpha in self.model.arch_parameters()]
    ...
    def step_darts(self, loss_wot):
        self.optimizer_wot.zero_grad()
        loss_wot.backward()
        self.optimizer_wot.step()
