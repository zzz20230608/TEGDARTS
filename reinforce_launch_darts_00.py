...
TORCH_HOME = "/workspace/sunshuqing/TEGNAS"  # Path that contains the nas-bench-201 database. If you only want to run on NASNET (i.e. DARTS) search space, then just leave it empty
data_paths = {
    "cifar10": "/workspace/sunshuqing/TEGNAS/cifar.python",
...
core_cmd = "CUDA_VISIBLE_DEVICES={gpuid} OMP_NUM_THREADS=4 python ./reinforce_darts_00.py \
